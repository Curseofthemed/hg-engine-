...
#define ITEM_WISHING_PIECE      (ITEM_PIXIE_PLATE + 208)
#define ITEM_TERA_CRYSTAL       (ITEM_PIXIE_PLATE + 209)
#define ITEM_ULTRANECROZIUM_Z   (ITEM_PIXIE_PLATE + 210)
#define ITEM_GREY_STONE         (ITEM_PIXIE_PLATE + 211)
#define ITEM_WELLSPRING_MASK    (ITEM_PIXIE_PLATE + 212)
#define ITEM_HEARTHFLAME_MASK   (ITEM_PIXIE_PLATE + 213)
#define ITEM_CORNERSTONE_MASK   (ITEM_PIXIE_PLATE + 214)
