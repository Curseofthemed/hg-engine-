...
#define SPECIES_SHADOW_MEWTWO 1076
#define MAX_MON_NUM (SPECIES_SHADOW_MEWTWO)
...
#define SPECIES_MEGA_ARCEUS (SPECIES_PALDEAN_FORMS_START + 27)
#define SPECIES_MEGA_PORYGON_Z (SPECIES_PALDEAN_FORMS_START + 28)
#define SPECIES_MEGA_MUK (SPECIES_PALDEAN_FORMS_START + 29)
#define SPECIES_KYUREM_OG (SPECIES_PALDEAN_FORMS_START + 30)
#define SPECIES_MEGA_DARKRAI (SPECIES_PALDEAN_FORMS_START + 31)
#define SPECIES_MEGA_RAPIDASH (SPECIES_PALDEAN_FORMS_START + 32)
#define SPECIES_MEGA_RHYPERIOR (SPECIES_PALDEAN_FORMS_START + 33)
#define SPECIES_MEGA_FLYGON (SPECIES_PALDEAN_FORMS_START + 34)
#define SPECIES_MEGA_SHADOW_MEWTWO (SPECIES_PALDEAN_FORMS_START + 35)
#define SPECIES_MEGA_MEGANIUM (SPECIES_PALDEAN_FORMS_START + 36)
#define SPECIES_MEGA_FERALIGATR (SPECIES_PALDEAN_FORMS_START + 37)
#define SPECIES_MEGA_TYPHLOSION (SPECIES_PALDEAN_FORMS_START + 38)
#define SPECIES_MEGA_SUICUNE (SPECIES_PALDEAN_FORMS_START + 39)
#define SPECIES_MEGA_ENTEI  (SPECIES_PALDEAN_FORMS_START + 40)
#define SPECIES_MEGA_RAIKOU  (SPECIES_PALDEAN_FORMS_START + 41)
#define SPECIES_KORAIDON_BATTLE  (SPECIES_PALDEAN_FORMS_START + 42)
#define SPECIES_MIRAIDON_BATTLE  (SPECIES_PALDEAN_FORMS_START + 43)
#define SPECIES_ZACIAN_BATTLE  (SPECIES_PALDEAN_FORMS_START + 44)
#define SPECIES_ZAMAZENTA_BATTLE  (SPECIES_PALDEAN_FORMS_START + 45)
#define SPECIES_VENUSAUR_GMAX  (SPECIES_PALDEAN_FORMS_START + 46)
#define SPECIES_ETERNATUS_BATTLE  (SPECIES_PALDEAN_FORMS_START + 47)
#define SPECIES_KYUREM_OG_W (SPECIES_PALDEAN_FORMS_START + 48)
#define SPECIES_KYUREM_OG_B (SPECIES_PALDEAN_FORMS_START + 49)
#define SPECIES_MEGA_GOODRA (SPECIES_PALDEAN_FORMS_START + 50)
#define SPECIES_MEGA_HAXORUS (SPECIES_PALDEAN_FORMS_START + 51)
#define SPECIES_CHARIZARD_GMAX (SPECIES_PALDEAN_FORMS_START + 52)
#define SPECIES_BLASTOISE_GMAX (SPECIES_PALDEAN_FORMS_START + 53)
#define SPECIES_BUTTERFREE_GMAX (SPECIES_PALDEAN_FORMS_START + 54)
#define SPECIES_PIKACHU_GMAX (SPECIES_PALDEAN_FORMS_START + 55)
#define SPECIES_MEOWTH_GMAX (SPECIES_PALDEAN_FORMS_START + 56)
#define MAX_SPECIES_INCLUDING_FORMS (SPECIES_MEOWTH_GMAX)  // 1348
